...
#define JOYSTICK
#if ENABLED(JOYSTICK)
  #define JOY_X_PIN   6//60  // RAMPS: Suggested pin A6 on AUX2
  #define JOY_Y_PIN   5//59  // RAMPS: Suggested pin A5 on AUX2
  //#define JOY_Z_PIN   58  // RAMPS: Suggested pin A4 on AUX2
  #define JOY_EN_PIN  8  // RAMPS: Suggested pin D44 on AUX2
  ...
  #define JOY_X_LIMITS { 0, 8126-100, 8126+100, 16368 } // min, deadzone start, deadzone end, max
  #define JOY_Y_LIMITS { 0, 7968-100, 7968+100, 16368 }
